      ...
      <div className="flex flex-wrap -mx-1 lg:-mx-4 justify-center gap-x-20 gap-y-3">
        ...
        <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
          ...
          <div className="space-y-4 text-center divide-y divide-gray-700">
            <div className="my-2 space-y-1">
              ...
              <p className="px-5 text-xs sm:text-base dark:text-gray-400">Web3 Developer</p>
            </div>
            <div className="flex justify-center pt-2 space-x-4 align-center">
              <a rel="noopener noreferrer" target="_blank" href="https://github.com/ari4325" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
            ...
            >
              <img
                ...
                alt="LinkedIn"
                className="w-4 h-4 fill-current hover:bg-violet-400"
              />
            </a>
              <a rel="noopener noreferrer" target="_blank" href="https://twitter.com/ArishmitG" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
        ...
        <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
          ...
          <div className="space-y-4 text-center divide-y divide-gray-700">
            ...
            <div data-tip="vimal.kumar@bennett.edu.in" aria-label="Email" className="tooltip tooltip-bottom p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400" onClick={() => {navigator.clipboard.writeText("vimal.kumar@bennett.edu.in")}}>
              <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
